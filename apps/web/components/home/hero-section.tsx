...
export function HeroSection() {
  return (
    <HeroVideoBackground>
      ...
      <Badge
        variant="outline"
        className="mb-5 border-white/20 bg-black/20 text-foreground backdrop-blur-sm"
      >
        World Cup 2026
      </Badge>

      <h1 className="mt-5 text-4xl font-bold tracking-tight text-foreground drop-shadow-sm sm:text-5xl">
        Goalaxify
      </h1>
